...
var prefix = ["Grün-", "Rot-", "Gelb-", "Blau-", "Lila-", "Elite-Mecha-"]; // length = 6, da 6 Einträge. Von 0-5.
...
function monsterGenerateHTML() {
    ...
    monsterAttack.innerHTML = "Angriffskraft: " + monsterArray[monsterArray.length - 1].monsterAttack;
    holdingDiv.appendChild(monsterAttack);
    var monsterAge = document.createElement("p");
    monsterAge.innerHTML = "Alter: " + monsterArray[monsterArray.length - 1].monsterAge;
