...
var playerName = "Antony"; // Ein paar globale Variablen, welche den Spieler darstellen.
var playerXP = 1; // Stellt die gesammelte Erfahrung des Spielers dar.
var playerXPperLevel = 700; // Da es nur einen Spieler gibt, ergibt sich noch nicht viel Sinn darin, für den Spieler ein interface (im Sinne der Programmierung) zu erstellen.
// Mehrere Arrays, welche jeweils Bauteile für Namen oder Eigenschaften der Monster beinhalten.
var prefix = ["Asozialer ", "Heftiger ", "Komischer ", "Verstörter ", "Zerstörender ", "Elite-Mecha-"]; // length = 6, da 6 Einträge. Von 0-5.
var monsterName = ["Schleim", "Ork", "Mensch", "Opfer", "Godzilla", "Doomnomitron"]; // length = 3, da 3 Einträge. Von 0-2.
var suffix = [", Vernichter der Welten", ", der Große", ", der Hässliche", ", der Grausame", ", Ultimativer Zerstörer aller Universen", ", der Herrscher sämtlicher Realitäten"]; // length = 6, da hier 6 Einträge sind. Von 0-5.
var img = ["alien.png", "loewe.png", "elefant.png", "tod.png", "dino.png", "dinokonda.png", "oktopus.png", "pinguin.png"];
...
function generateMonster() {
    ...
    for (var i = 0; i < Mons; i++) {
        ...
        var newMonsterAttack = generateMonsterAttack();
...
function monsterGenerateHTMLAll() {
    for (var i = 0; i < getMonsterCount(); i++) {
        monsterGenerateHTML(i);
    }
}
function clearMonsterCell() {
    var GoAway = document.getElementById(monsterHolder);
...
function monsterGenerateHTML(i) {
    ...
    var monsterCount = i; // Die aktuelle Anzahl vorhandener Monster, zudem auch die neue Zahl für das Monster-Array.
